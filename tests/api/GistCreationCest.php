...
class GistCreationCest
{
     ...
     * @param ApiTester $I
     */
    public function non_authenticated_user_tries_to_create_a_gist_and_fails(ApiTester $I){
    ...
    public function authenticated_user_tries_to_create_a_gist_and_succeed(ApiTester $I){
